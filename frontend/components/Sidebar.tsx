...
import { Terminal, Activity, FileCode2, Settings, LayoutDashboard, History, FileText, Menu, X } from 'lucide-react'
      ...
      >
        ...
        <div className="h-16 flex items-center justify-center lg:justify-start lg:px-6 border-b border-slate-700/50 relative overflow-hidden safe-top">
          ...
          <span className="ml-3 font-mono font-bold text-gruvbox-fg hidden lg:block 
                           tracking-wide relative z-10 shadow-accent/20 drop-shadow-md">
            Agent IDE
          </span>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className={`relative z-10 
                      ${active ? 'animate-soft-pulse drop-shadow-[0_0_8px_rgba(215,153,33,0.6)]' 
                               : 'group-hover:scale-110 transition-transform duration-200'}`}>
        {icon}
      </div>
      <span className="ml-3 font-medium text-sm hidden lg:block relative z-10">
        {label}
      </span>
